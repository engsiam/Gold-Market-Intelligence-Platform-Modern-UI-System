  ...
  return (
    <section className="py-24 bg-dark-bg relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <StaggerContainer className="grid lg:grid-cols-3 gap-8 mt-12">
          ...
          <StaggerItem className="h-full">
            <div className="bg-dark-surface rounded-xl border border-gold-brown/20 overflow-hidden group relative flex flex-col justify-end min-h-[400px] h-full">
